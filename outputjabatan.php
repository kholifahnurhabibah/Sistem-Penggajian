...
<html>
<head>
<title>FORM OUTPUT JABATAN</title>
...
<form id="form1" name="form1" method="post">
    ...
    <tr>
      <td height="50" align="center" bgcolor="pink"><strong><font face="courier new" size= "6pt" color="#000000">FORM OUTPUT JABATAN</font></strong></td>
    </tr>
	    <tr>
    ...
    $query=mysql_query("select * from jabatan",$konek) or die (mysql_error());
	echo "<table border='1' width='700px'>";
    echo "<tr><td> Kode Jabatan</td><td>Jenis Jabatan</td><td>Tunjangan</td></td></tr>";
