...
<html>
<head>
<title>FORM OUTPUT GOLONGAN</title>
...
<form id="form1" name="form1" method="post">
    ...
    <tr>
      <td height="50" align="center" bgcolor="pink"><strong><font face="courier new" size= "6pt" color="#000000">FORM OUTPUT GOLONGAN</font></strong></td>
    </tr>
	    <tr>
    ...
    $query=mysql_query("select * from Golongan",$konek) or die (mysql_error());
	echo "<table border='1' width='500px'>";
    echo "<tr><td> Kode_Golongan</td>
	<td>Jenis_Golongan</td> 
	<td>Gaji_Pokok</td></tr>";
