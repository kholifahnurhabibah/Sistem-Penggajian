...
<html>
<head>
<title>FORM OUTPUT POTONGAN</title>
...
<form id="form1" name="form1" method="post">
    ...
    <tr>
      <td height="50" align="center" bgcolor="pink"><strong><font face="courier new" size= "6pt" color="#000000">FORM OUTPUT POTONGAN</font></strong></td>
    </tr>
	    <tr>
    ...
    $query=mysql_query("select * from Potongan",$konek) or die (mysql_error());
	echo "<table border='1' width='500px'>";
    echo "<tr><td> Kode Potongan</td><td>Nama Potongan</td><td>Total Potongan</td></tr>";
